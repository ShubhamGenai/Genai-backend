...
router.patch("/quiz/:id/question-bank", contentController.patchQuizQuestionBank)
...
router.get("/upload-progress", contentController.getUploadProgress)
router.post("/upload-library-document", contentController.streamUploadLibraryDocument)
router.get("/get-library-documents", contentController.getLibraryDocuments)
router.get("/library-document/:id", contentController.getLibraryDocumentById)
router.put("/library-document/:id", contentController.updateLibraryDocument)
router.delete("/library-document/:id", contentController.deleteLibraryDocument)
